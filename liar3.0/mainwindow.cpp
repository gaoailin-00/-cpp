...
void MainWindow::createIntroScene() {
    ...
    QString imgPath =
        QCoreApplication::applicationDirPath() + "/image-begin.png";
    QPixmap pix(imgPath);
    if (!pix.isNull()) {
...
void MainWindow::createHistoryScene() {
    ...
    QString imgPath =
        QCoreApplication::applicationDirPath() + "/image-history.png";
    QPixmap pix(imgPath);
    if (!pix.isNull()) {
        ...
        historyImageLabel->setStyleSheet(
            "color:#ff5555; font-size:28px; font-weight:bold;"
            );
    }
...
void MainWindow::createRuleScene() {
    ...
    QString imgPath =
        QCoreApplication::applicationDirPath() + "/image-rule.png";
    QPixmap pix(imgPath);
    if (!pix.isNull()) {
...
void MainWindow::createTavernScene() {
    ...
    QString hallImgPath =
        QCoreApplication::applicationDirPath() + "/image-hall.png";
    ...
    if (!hallPix.isNull()) {
        ...
        bgLabel->setStyleSheet(
            "color:#ff5555; font-size:28px; font-weight:bold; background:#111;"
            );
    }
...
void MainWindow::createEndScene() {
    ...
    btnLayout->addSpacing(110); // 上移约1.5cm（原50，改为110）
